 ...
 *
 * Reads `public.procureai_subscriptions`, a security_invoker view over
 * `procureai.subscriptions`. RLS restricts rows to the caller's org, and the
