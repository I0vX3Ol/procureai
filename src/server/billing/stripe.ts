...
export function createCheckoutSession(
  ...
  params: {
    ...
    successUrl: string;
    cancelUrl: string;
    /** Shown on the card statement after the account prefix, e.g. NEXUDEL* PROCUREAI */
      ...
      subscription_data: {
        ...
        ...(params.trialDays
          ? {
              ...
              // If the trial runs out and no card was ever added, cancel
              // rather than pause — matches the "14-day free trial" copy,
              // and an indefinitely-paused free subscription is not a state
              // we want to have to reason about.
