/**
 * Stripe HTTP endpoints for ProcureAI, mounted from `src/server.ts`.
 *
 ...
 *   POST /api/billing/resume     authenticated -> clear a pending cancellation
 *   POST /api/billing/portal     authenticated -> Stripe Billing Portal URL
 *   POST /api/billing/webhook    Stripe -> updates procureai.subscriptions
 *
