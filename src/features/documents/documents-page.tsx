...
export function DocumentsPage() {
  ...
  const queryData = documentsQuery.data;
  const docs = useMemo(() => queryData ?? [], [queryData]);
      ...
      <CardContent className="space-y-4 text-sm">
        ...
        <div>
          ...
          {document.status === "failed" ? (
            <div className="mt-2 rounded-lg border border-destructive/40 bg-destructive/10 p-3 text-xs text-destructive-emphasis">
