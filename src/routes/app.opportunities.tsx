...
export const Route = createFileRoute('/app/opportunities')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Discover and qualify government and enterprise procurement opportunities.' },
      { property: 'og:title', content: 'Opportunities — ProcureAI' },
      { property: 'og:description', content: 'Discover and qualify government and enterprise procurement opportunities.' },
    ],
  }),
