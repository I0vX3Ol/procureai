...
export const Route = createFileRoute('/app/organization')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Manage your company profile, team members, and access roles.' },
      { property: 'og:title', content: 'Organization — ProcureAI' },
      { property: 'og:description', content: 'Manage your company profile, team members, and access roles.' },
    ],
  }),
